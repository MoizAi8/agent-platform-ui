  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-hero">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        >
          <Button size="xl" className="gap-2"><Bot className="h-4 w-4" /> Launch Dashboard</Button>
          <Button variant="glass" size="xl" className="gap-2"><Cpu className="h-4 w-4" /> View Demo</Button>
        </motion.div>
