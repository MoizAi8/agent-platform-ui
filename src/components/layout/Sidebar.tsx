  ...
  return (
    ...
    >
      ...
      <div className="border-t border-sidebar-border px-3 py-3">
        ...
        <button onClick={() => setCollapsed(!collapsed)} className="mt-2 flex w-full items-center justify-center rounded-lg px-3 py-2 text-sidebar-foreground transition-colors hover:bg-muted">
