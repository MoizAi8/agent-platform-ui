...
export function AgentCard({ agent, index }: AgentCardProps) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.08, duration: 0.5, ease: [0.25, 0.1, 0.25, 1] }}
      className="group relative rounded-xl border border-border/50 bg-card p-5 shadow-sm transition-all duration-300 hover:border-accent/30 hover:shadow-[0_0_30px_-5px_rgba(139,92,246,0.1)]"
    >
